...
import 'package:annapurna/widgets/app_icon.dart';
import 'package:annapurna/widgets/big_text.dart';
import 'package:annapurna/widgets/expandable_text_widget.dart';
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  BigText(text: "\$0.00  X  ${controller.inCartItems}", color: AppColors.mainBlackColor,size: Dimensions.font26),
                  GestureDetector(
                    onTap: (){
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      padding: EdgeInsets.only(top: Dimensions.height20, bottom: Dimensions.height20, left: Dimensions.width20, right: Dimensions.width20),
                      child: BigText(text: "\$0.00 | Add to Cart", color: Colors.white,),
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(Dimensions.radius20),
                        color: AppColors.mainColor,
                      ),
